...
if(gameState==="level2"){
  ...
  if(touches.length>0||keyDown("space")&&turtlegroup.isTouching(ninja)){
...
if(touches.length>0||keyDown("space")&&turtlegroup[j].isTouching(ninja)){
...
sword.setCollider("rectangle",0,0,60,20)
sword.debug=true
sword.x=ninja.x+100
sword.visible=true
